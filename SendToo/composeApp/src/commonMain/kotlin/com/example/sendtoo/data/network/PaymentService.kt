...
import com.example.sendtoo.domain.error.InvalidAmount
import com.example.sendtoo.domain.error.NetworkError
import com.example.sendtoo.domain.error.PaymentError
import com.example.sendtoo.domain.error.RecipientNotFound
import com.example.sendtoo.domain.error.UnknownPaymentError
import com.example.sendtoo.domain.error.UnsupportedCurrency
import com.example.sendtoo.domain.error.defaultErrorMessage
import com.example.sendtoo.domain.model.PaymentErrorBody
